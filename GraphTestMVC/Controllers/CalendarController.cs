...
using GraphTestMVC.Graph;
using GraphTestMVC.Alerts;

namespace GraphTestMVC.Controllers
{
    public class CalendarController : Controller
    {
        ...
        public CalendarController(GraphServiceClient graphClient, ILogger<HomeController> logger)
        {
